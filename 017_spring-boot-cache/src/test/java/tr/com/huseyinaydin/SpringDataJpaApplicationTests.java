...
public class SpringDataJpaApplicationTests {
    ...
    public void getProductsShouldReturnAllProducts() throws Exception {
        when(productRepository.findAll()).thenReturn(Arrays.asList(
                ...
                ,new Product(2, "demo2", 2000, "demo ürün2", "basit ürün2")));
    ...
    public void getProductByIdTest() throws Exception {
        when(productRepository.findById(108)).thenReturn(Optional.of(new Product(108, "test", 200, "açıklama", "mutfak")));
    ...
    public void deleteProductByIdTest() throws Exception {
        //Bu kodla, productRepository üzerinde deleteById metodunu çağırdığımda herhangi bir işlem yapmadan geçmesini sağlıyorum; yani test sırasında gerçek bir silme işlemi gerçekleşmiyor.
